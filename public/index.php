...
<body onload="startup()">
    <!-- Hero Section Start -->
    <header id="header"
        class="h-screen bg-slate-200 relative overflow-hidden bg-no-repeat bg-cover bg-fixed bg-center duration-700"
        style="background-image: url('img/wisata/img100.jpg');">
        <div class="container">
            ...
            <a id="btnScroll" href="#gallery" class="rounded-full bg-primary text-white text-2xl px-4 py-2 duration-1000 absolute opacity-0 -bottom-[10%] left-0 right-0 m-auto max-w-max lg:duration-[2000ms]">Click Here!</a>
            <a id="gallery" class="absolute bottom-[15%] "></a>
        </div>
    </header>
    <!-- Hero Section End -->
        ...
        <div class="container">
            <div class="flex flex-wrap justify-center">
                ...
                <div class="w-full p-2 md:w-1/2 lg:w-1/3 xl:w-1/4">
                    <div onmouseover="bg('img<?=$win[$i]?>')"
                        class="rounded-xl shadow-lg overflow-hidden group hover:shadow-2xl h-full">
                        <div class="relative h-60">
                            <img src="img/wisata/img<?=$win[$i]?>" alt="Avatar" class="w-full h-full object-cover"
                                loading="lazy">
                            <div
                                class="overflow-y-auto p-4 absolute -bottom-full left-0 w-full h-0 flex flex-col justify-start items-start bg-primary group-hover:h-full duration-1000 group-hover:bottom-0 opacity-0 group-hover:opacity-100">
                                <div class="font-bold text-lg text-white capitalize">img
                                    <?=$win[$i]?>
                                </div>
                                ...
                                <div class="text-white text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit. Itaque ipsum temporibus magnam quidem rem deleniti ducimus! Soluta fuga et est
                                    ipsam, aperiam, sit deleniti iste quaerat incidunt veritatis cum recusandae? Lorem
                                    ipsum dolor sit, amet consectetur adipisicing elit. Vel tempora magni dolore nemo
                                    reiciendis ad officiis itaque debitis rem sint sunt quis a fugiat tempore sit et
                                    iste laudantium similique, eius iure! Nemo obcaecati eveniet ratione, maiores quasi
                                    at iste animi recusandae hic enim? Deleniti totam ipsum aut itaque nobis atque
                                    aperiam earum accusantium corrupti quisquam error quibusdam repudiandae voluptas
                                    culpa beatae, facilis non soluta tempora modi architecto enim. Consequatur amet
                                    facere porro atque laborum saepe quae ipsa delectus possimus ipsam, culpa
                                    consequuntur itaque nulla provident impedit. Molestiae architecto nostrum, minima ex
                                    adipisci, sequi eligendi numquam voluptates eveniet doloribus excepturi.</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="relative">
        <a id="btnTop" href="#header" class="bg-primary text-white text-base p-3 rounded-full fixed -bottom-[10%] right-[8%] opacity-0 z-50 duration-1000">Top</a>
    </div>
    <!-- Main Galery End -->
